  ...
  return (
    <main className="relative flex min-h-screen w-full flex-col items-center overflow-hidden px-5 transition-all sm:px-10 md:px-20">
      <section className="mb-8 w-full max-w-[1360px] px-40">
        <div className="flex items-center gap-2 py-4">
          ...
          <div>
            ...
            <p className="ml-2 inline-block text-lg opacity-75">2023</p>
          </div>
      ...
      <section className="flex w-full max-w-[1360px] px-40">
        <p>
          TrackIt is a web-based application that simplifies shipment tracking
          by providing a unified platform to monitor your packages' status and
          journey, across various couriers.
        </p>
      ...
      <section className="relative w-full max-w-[1360px] px-40 py-2">
        <ul className="grid grid-cols-3 gap-2">
          <li className="rounded-lg bg-border/5 p-4">
            <h3 className="font-semibold">Centralized Tracking Dashboard</h3>
            <p className="font-light opacity-75">
              Consolidated view of shipments and their current statuses.
            </p>
          </li>
          <li className="rounded-lg bg-border/5 p-4">
            <h3 className="font-semibold">Multi-Courier Support</h3>
            <p className="font-light opacity-75">
              Tracking support for UPS, USPS, FedEx, OnTrac, and more.
            </p>
          </li>
          <li className="rounded-lg bg-border/5 p-4">
            <h3 className="font-semibold">Detailed Tracking History</h3>
            <p className="font-light opacity-75">
              View status, location, and date information for each shipment.
            </p>
          </li>
          <li className="rounded-lg bg-border/5 p-4">
          ...
          <li className="rounded-lg bg-border/5 p-4">
            <h3 className="font-semibold">Clear and easy to understand UI</h3>
            <p className="font-light opacity-75">
              Intuitive and responsive design for a seamless user experience.
              With mobile support for tracking on the go.
            </p>
          </li>
          <li className="rounded-lg bg-border/5 p-4">
            <h3 className="font-semibold">Power User Features</h3>
            <p className="font-light opacity-75">
              Search and filter functionality, undo accidental deletions,
              shortcuts, and links to courier websites.
            </p>
          </li>
        </ul>
      </section>
