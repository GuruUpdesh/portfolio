...
const Header = () => {
    return (
        <header className="z-20 w-full max-w-[1440px] rounded-b-[40px] border bg-background px-5 pb-5 pt-2 transition-all sm:border-t-0 md:rounded-b-[80px] md:px-20 md:pt-10">
