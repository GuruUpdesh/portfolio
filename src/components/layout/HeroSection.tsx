...
const HeroSection = () => {
    return (
        <div className="relative">
            <SizeTracker
                className="relative z-10 overflow-clip rounded-br-[calc(var(--height)-1px)] border border-l-0 border-t-0 bg-background pt-[74px] transition-all md:rounded-bl-[60px] md:border-l md:pt-0"
            >
