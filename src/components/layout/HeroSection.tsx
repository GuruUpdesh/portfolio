...
const HeroSection = () => {
    return (
        <div className="relative">
            ...
            <SizeTracker className="relative z-10 overflow-clip rounded-br-[calc(var(--height)-1px)] border border-l-0 border-t-0 bg-background pt-[74px] transition-all md:rounded-bl-[60px] md:border-l md:pt-0">
                ...
                <div className="absolute top-0 -z-10 h-full w-full overflow-clip blur-[100px]">
                    <div className="absolute top-[25%] h-[200%] w-[200%] -hue-rotate-30 md:right-[-50%] md:top-[-50%] md:w-[100%]">
                        <Image
                            fill
                            src="/logo.webp"
                            alt=""
